    ...
    <Tabs
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          href: enabledModules.includes('overview') ? undefined : null,
        }}
      />
      <Tabs.Screen
        name="pieces"
        options={{
          ...
          href: enabledModules.includes('pieces') ? undefined : null,
        }}
      />
      <Tabs.Screen
        name="kiln"
        options={{
          ...
          href: enabledModules.includes('kiln') ? undefined : null,
        }}
      />
      <Tabs.Screen
        name="library"
        options={{
          ...
          href: enabledModules.includes('glaze-atlas') ? undefined : null,
        }}
      />
      <Tabs.Screen
        name="profile"
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          href: enabledModules.includes('community') ? undefined : null,
        }}
      />
    </Tabs>
    </BottomSheetModalProvider>
