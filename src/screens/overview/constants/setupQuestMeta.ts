import type { SetupQuestKey } from '@/src/screens/overview/setupQuests/setupQuestCatalog';
import { Calculator, CalendarDays, Database, Flame, Layers, Plus, Sparkles, Type as TypeIcon, Zap } from 'lucide-react-native';
...
export const SETUP_QUEST_META: Record<SetupQuestKey, { Icon: MissionIcon; iconColor: string; iconBg: string }> = {
  ...
  'set-text-size': { Icon: TypeIcon, iconColor: 'hsl(24 30% 40%)', iconBg: 'hsl(34 30% 90%)' },
