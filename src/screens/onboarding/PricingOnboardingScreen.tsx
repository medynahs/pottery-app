...
export default function PricingOnboardingScreen() {
  ...
  return (
    <View className="flex-1 bg-background" style={{ paddingTop: insets.top }}>
      <ScrollView className="flex-1 px-6" contentContainerStyle={{ paddingBottom: insets.bottom + 28 }}>
        <View className="pt-6 pb-5">
          <Text className="text-[11px] font-semibold uppercase tracking-[2px] text-primary mb-3">Pricing Setup</Text>
          <Text className="text-3xl text-foreground" style={{ fontFamily: 'Fraunces_700Bold', lineHeight: 38 }}>
            Pick the pricing profile that matches how you make and sell.
          </Text>
          <Text className="text-sm text-muted-foreground mt-3 leading-6">
            This only sets your starting defaults. You can fine-tune firing, clay, glaze, labor, fees, and tax later in Pricing Rules.
          </Text>
        </View>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.82}
          className={`rounded-2xl items-center justify-center py-4 ${isSubmitting ? 'bg-muted' : 'bg-foreground'}`}
